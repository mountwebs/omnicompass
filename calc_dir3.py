...
if __name__ == "__main__":
    # Format: (latitude, longitude, altitude in meters)
    pos1 = (59.577698, 9.257585, 86)  # Notodden
    # pos1 = (59.9111, 10.7528, 50) # Oslo
    # pos2 = (40.7128, -74.0060, 10) # new york
    # pos2 = (60.3913, 5.3221, 86)   # Bergen
    # pos2 = (59.577698, 9.257585, 86)  # Notodden
    pos2 = (-18.86361400868, 70.382275490587, 421997.09937094)   # ISS



    # Earth surface distance
    surface_dist = haversine_distance(pos1[:2], pos2[:2])

    # 3D ECEF positions
    ecef_pos1 = geodetic_to_ecef(*pos1)
    ecef_pos2 = geodetic_to_ecef(*pos2)

    # 3D straight-line distance through space
    dist_3d = euclidean_distance(ecef_pos1, ecef_pos2)

    # Azimuth and elevation angle
    azimuth, elevation = calculate_azimuth_elevation(pos1, pos2)

    print(f"Surface distance (great-circle): {surface_dist / 1000:.2f} km")
    print(f"3D straight-line distance:       {dist_3d / 1000:.2f} km")
